      ...
      ***************************************************************
      * Modifications
      * 2020-09-29 Hartanto  V0R0M6
      *   Remove the PERFORM which run the call for RPTPRINT which
      *   was removed previously.
      * 2020-09-26 Hartanto  V0R0M5
      *   Remove call for RPTPRINT as it needed to be called in a
      *   separate JCL step.
      ...
      *Closing Functions********************************************
      * This last paragraph will close all files ever opened
      **************************************************************
